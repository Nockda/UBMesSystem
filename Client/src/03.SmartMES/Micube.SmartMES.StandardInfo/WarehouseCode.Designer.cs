namespace Micube.SmartMES.StandardInfo
{
    partial class WarehouseCode
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.pnlContent.Controls.Add(this.grdWarehouse);
            // 
            // grdWarehouse
            // 
            this.grdWarehouse.Caption = "그리드제목( LanguageKey를 입력하세요)";
            this.grdWarehouse.Dock = System.Windows.Forms.DockStyle.Fill;
            this.grdWarehouse.GridButtonItem = ((Micube.Framework.SmartControls.GridButtonItem)((((((Micube.Framework.SmartControls.GridButtonItem.Add | Micube.Framework.SmartControls.GridButtonItem.Copy) 
            | Micube.Framework.SmartControls.GridButtonItem.Delete) 
            | Micube.Framework.SmartControls.GridButtonItem.Preview) 
            | Micube.Framework.SmartControls.GridButtonItem.Import) 
            | Micube.Framework.SmartControls.GridButtonItem.Export)));
            this.grdWarehouse.IsUsePaging = false;
            this.grdWarehouse.LanguageKey = "GRIDWAREHOUSEINFO";
            ...
            this.grdWarehouse.Size = new System.Drawing.Size(475, 401);
            ...
            this.Name = "WarehouseCode";
            this.Text = "InventoryCode";
