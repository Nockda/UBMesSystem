...
namespace Micube.SmartMES.StandardInfo
{
    ...
    /// 업  무  설  명  : 세부공정코드를 관리한다.
    /// 생    성    자  : 모세찬
    /// 생    성    일  : 2020-04-06
    /// 수  정  이  력  : 2020-05-15 | jylee => 공정관리화면으로 통합
    /// 
    /// 
    /// </summary>
    public partial class ProcessdCode : SmartConditionBaseForm
    {
        public ProcessdCode()
        {
            InitializeComponent();
        ...
        private void InitializeGrid()
        {
            ...
            grdInfo.View.SetSortOrder("PROCESSDID");
            grdInfo.View.SetAutoFillColumn("DESCRIPTION");

            grdInfo.View.AddTextBoxColumn("PROCESSDID", 80)
                            .SetValidationKeyColumn()
                            .SetValidationIsRequired();
            grdInfo.View.AddTextBoxColumn("PROCESSDNAMEKOR", 120);
            grdInfo.View.AddTextBoxColumn("PROCESSDNAMEENG", 120);
            grdInfo.View.AddTextBoxColumn("PROCESSDNAMEJPN", 120);
        ...
        protected override void OnToolbarSaveClick()
        {
            ...
            ExecuteRule("SaveProcessdCode", changed);
        }
        ...
        protected async override Task OnSearchAsync()
        {
            ...
            DataTable dtInfo = await QueryAsync("GetProcessdCode", "00001", values);
