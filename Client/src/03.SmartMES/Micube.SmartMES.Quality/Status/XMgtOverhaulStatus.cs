...
{
    /// <summary>
    /// 프 로 그 램 명  : 품질관리 > 항목 > 오버홀 진행현황
    /// 업  무  설  명  : 오버홀 진행현황 조회 한다.
    /// 생    성    자  : 강유라
    /// 생    성    일  : 2020-05-29
    /// 수  정  이  력  : 
    /// 
    /// 
    /// </summary>
    public partial class XMgtOverhaulStatus : SmartConditionBaseForm
    {
        #region Local Variables

        // TODO : 화면에서 사용할 내부 변수 추가
        string caption = Language.Get("XMSTATUSCUSTOMER");

        #endregion

        #region 생성자

        public XMgtOverhaulStatus()
        {
            InitializeComponent();
        }
        ...
        private void InitializeGrid()
        {
            ...
            grdOverhaulStatus.GridButtonItem = GridButtonItem.Export;
            grdOverhaulStatus.View.GridMultiSelectionMode = GridMultiSelectionMode.CellSelect;
            grdOverhaulStatus.View.SetIsReadOnly();

            var type = grdOverhaulStatus.View.AddGroupColumn("");
            type.AddTextBoxColumn("TYPE", 150).SetLabel("TYPE");

            //7월
            var july = grdOverhaulStatus.View.AddGroupColumn("JULY");
            ...
            //8월
            var august = grdOverhaulStatus.View.AddGroupColumn("AUGUST");
            ...
            //9월
            var september = grdOverhaulStatus.View.AddGroupColumn("SEPTEMBER");
            ...
            //10월
            var october = grdOverhaulStatus.View.AddGroupColumn("OCTOBER");
            ...
            //11월
            var november = grdOverhaulStatus.View.AddGroupColumn("NOVEMBER");
            ...
            //12월
            var december = grdOverhaulStatus.View.AddGroupColumn("DECEMBER");
            ...
            //1월
            var january = grdOverhaulStatus.View.AddGroupColumn("JANUARY");
            ...
            //2월
            var feburary = grdOverhaulStatus.View.AddGroupColumn("FEBURARY");
            ...
            //3월
            var march = grdOverhaulStatus.View.AddGroupColumn("MARCH");
            ...
            //4월
            var april = grdOverhaulStatus.View.AddGroupColumn("APRIL");
            ...
            //5월
            var may = grdOverhaulStatus.View.AddGroupColumn("MAY");
            ...
            //6월
            var june = grdOverhaulStatus.View.AddGroupColumn("JUNE");
            ...
            //합계
            var sum = grdOverhaulStatus.View.AddGroupColumn("SUM");
            ...
            grdOverhaulStatus.View.PopulateColumns();
        }
        ...
        protected override void OnToolbarSaveClick()
        {
            ...
            // TODO : 저장 Rule 변경
            //DataTable changed = grdOverhaulStatus.GetChangedRows();
        ...
        protected async override Task OnSearchAsync()
        {
            ...
            string queryId = "SelectXMgtOverhaulStatusCustomer";
            ...
            { 
                case "Customer":
                    queryId = "SelectXMgtOverhaulStatusCustomer";
                    caption = Language.Get("XMSTATUSCUSTOMER");
                    break;

                case "ItemFamily":
                    queryId = "SelectXMgtOverhaulStatusItemFamily";
                    caption = Language.Get("XMSTATUSITEMFAMILY");
                    break;

                case "Line":
                    queryId = "SelectXMgtOverhaulStatusLine";
                    caption = Language.Get("XMSTATUSLINE");
                    break;
            }
            ...
            grdOverhaulStatus.DataSource = dt;
        }
        ...
        protected override void OnValidateContent()
        {
            ...
            // TODO : 유효성 로직 변경
            grdOverhaulStatus.View.CheckValidation();
        ...
        {
            grdOverhaulStatus.Caption = caption;
        }
