...
namespace Micube.SmartMES.SystemManagement
{
    ...
    /// 
    /// </summary>
    public partial class Message : SmartConditionBaseForm
    {
        ...
        private void InitializeMessage()
        {
            ...
            grdMessage.View.AddComboBoxColumn("LANGUAGETYPE", 80, new SqlQuery("GetCodeList", "00001", "CODECLASSID=LanguageType", $"LANGUAGETYPE={Micube.Framework.UserInfo.Current.LanguageType}"))
                .SetValidationIsRequired();
            grdMessage.View.AddComboBoxColumn("VALIDSTATE", 80, new SqlQuery("GetCodeList", "00001", "CODECLASSID=ValidState", $"LANGUAGETYPE={Micube.Framework.UserInfo.Current.LanguageType}"))
        ...
        private void View_AddingNewRow(Micube.Framework.SmartControls.Grid.BandedGrid.SmartBandedGridView sender, Micube.Framework.SmartControls.Grid.AddNewRowArgs args)
        {
