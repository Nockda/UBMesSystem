...
namespace Micube.SmartMES.SystemManagement
{
    ...
    /// 
    /// </summary>
    public partial class UserClassUser : SmartConditionBaseForm
    {
        ...
        private void InitializeGridUserClassUser()
        {
            ...
            grdUserClassUser.View.AddComboBoxColumn("DEPARTMENT", 100, new SqlQuery("GetDepartmentList", "00001", $"LANGUAGETYPE={UserInfo.Current.LanguageType}"))
        ...
        private void UserSearchPopup(string userClassId)
        {
            ...
            userListPopup.GridColumns.AddComboBoxColumn("DEPARTMENT", 100, new SqlQuery("GetDepartmentList", "00001", $"LANGUAGETYPE={UserInfo.Current.LanguageType}"))
                .SetTextAlignment(TextAlignment.Center);
