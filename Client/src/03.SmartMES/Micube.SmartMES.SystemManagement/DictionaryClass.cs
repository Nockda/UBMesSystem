...
namespace Micube.SmartMES.SystemManagement
{
    ...
    /// 
    /// </summary>
    public partial class DictionaryClass : SmartConditionBaseForm
    {
        ...
        private void InitializeGrid()
        {
            ...
            grdDictionaryClass.View.AddComboBoxColumn("VALIDSTATE", 80, new SqlQuery("GetCodeList", "00001", $"LANGUAGETYPE={UserInfo.Current.LanguageType}"))
